...
![Tech Stack](https://img.shields.io/badge/Stack-React%20%7C%20Vite%20%7C%20Tailwind%20%7C%20Touch%20Friendly-38bdf8.svg)
...
*   **工具栏交互**：
    *   桌面端支持鼠标滚轮和按钮控制工具栏滑动。
    *   移动端采用扩展按钮模式，节省屏幕空间，点击可查看更多功能。
    *   自适应布局，根据屏幕尺寸调整按钮大小和间距。
...
### v2.4.2 (Current)
*   **移动端工具栏优化**：
    *   新增移动端专用滑动组件，支持触摸手势操作。
    *   优化按钮尺寸和间距，提高移动端触摸友好性。
    *   添加移动端专用视觉反馈和滑动指示器。
    *   实现双模式架构，移动端和桌面端使用不同布局。
